...
# %% [markdown] papermill={"duration": 0.148859, "end_time": "2024-03-14T11:06:59.728436", "exception": false, "start_time": "2024-03-14T11:06:59.579577", "status": "completed"}
# # SGWB Data Generation – Noise 4
#
# Noise only dataset with LDC Spritz noise curves only, with no orbit file. We use constant and equal LTTs (no orbit files) of 8.3 seconds.
#
...
# BASEDIR="/scratch/muck0/jb611z/sgwb-datasets/noise-4"
# mkdir -p $BASEDIR
# nohup papermill noise-4.ipynb $BASEDIR/noise-4.ipynb -p BASEDIR "$BASEDIR" > $BASEDIR/nohup.out 2>&1 &
# ```

# %% papermill={"duration": 2.038265, "end_time": "2024-03-14T11:07:01.881080", "exception": false, "start_time": "2024-03-14T11:06:59.842815", "status": "completed"}
import os
import logging
import numpy as np
...
# %% papermill={"duration": 0.116255, "end_time": "2024-03-14T11:07:02.135091", "exception": false, "start_time": "2024-03-14T11:07:02.018836", "status": "completed"} tags=["parameters"]
...
# %% papermill={"duration": 0.138174, "end_time": "2024-03-14T11:07:02.396669", "exception": false, "start_time": "2024-03-14T11:07:02.258495", "status": "completed"} tags=["injected-parameters"]
# Parameters
BASEDIR = "/scratch/muck0/jb611z/sgwb-datasets/noise-4a"


# %% papermill={"duration": 0.395772, "end_time": "2024-03-14T11:07:02.904922", "exception": false, "start_time": "2024-03-14T11:07:02.509150", "status": "completed"}
# Copy requirements.txt
# !cp requirements.txt $BASEDIR

# %% [markdown] papermill={"duration": 0.125177, "end_time": "2024-03-14T11:07:03.153980", "exception": false, "start_time": "2024-03-14T11:07:03.028803", "status": "completed"}
# ## Instrument

# %% papermill={"duration": 0.144904, "end_time": "2024-03-14T11:07:03.413644", "exception": false, "start_time": "2024-03-14T11:07:03.268740", "status": "completed"}
a_day = 24 * 3600  # s
a_year = 365.25 * a_day  # s

# %% papermill={"duration": 0.894211, "end_time": "2024-03-14T11:07:04.436377", "exception": false, "start_time": "2024-03-14T11:07:03.542166", "status": "completed"}
# Define instrument
...
# %% papermill={"duration": 2599.629389, "end_time": "2024-03-14T11:50:24.227790", "exception": false, "start_time": "2024-03-14T11:07:04.598401", "status": "completed"}
# Run simulation
...
# %% papermill={"duration": 342.888651, "end_time": "2024-03-14T11:56:07.164663", "exception": false, "start_time": "2024-03-14T11:50:24.276012", "status": "completed"}
...
# %% [markdown] papermill={"duration": 9.457298, "end_time": "2024-03-14T11:56:28.036420", "exception": false, "start_time": "2024-03-14T11:56:18.579122", "status": "completed"}
...
# %% papermill={"duration": 0.127718, "end_time": "2024-03-14T11:56:28.857246", "exception": false, "start_time": "2024-03-14T11:56:28.729528", "status": "completed"}
def asd(x, fs, **kwargs):
...
# %% papermill={"duration": 0.122797, "end_time": "2024-03-14T11:56:29.087116", "exception": false, "start_time": "2024-03-14T11:56:28.964319", "status": "completed"}
...
# %% papermill={"duration": 33.077781, "end_time": "2024-03-14T11:57:02.248332", "exception": false, "start_time": "2024-03-14T11:56:29.170551", "status": "completed"}
_, axes = plt.subplots(
...
# %% [markdown] papermill={"duration": 7.976744, "end_time": "2024-03-14T11:57:20.786884", "exception": false, "start_time": "2024-03-14T11:57:12.810140", "status": "completed"}
...
# %% papermill={"duration": 9.393083, "end_time": "2024-03-14T11:57:37.994419", "exception": false, "start_time": "2024-03-14T11:57:28.601336", "status": "completed"}
...
# %% papermill={"duration": 102.070265, "end_time": "2024-03-14T11:59:27.684622", "exception": false, "start_time": "2024-03-14T11:57:45.614357", "status": "completed"}
_, axes = plt.subplots(
    2, 1, figsize=(12, 7), sharex=True, gridspec_kw={"height_ratios": [2, 1]}
)
...
# %% [markdown] papermill={"duration": 8.108332, "end_time": "2024-03-14T11:59:44.444092", "exception": false, "start_time": "2024-03-14T11:59:36.335760", "status": "completed"}
# ## TDI

# %% papermill={"duration": 8.070883, "end_time": "2024-03-14T12:00:00.451617", "exception": false, "start_time": "2024-03-14T11:59:52.380734", "status": "completed"}
...
# %% papermill={"duration": 8928.770977, "end_time": "2024-03-14T14:29:12.290740", "exception": false, "start_time": "2024-03-14T12:00:23.519763", "status": "completed"}
...
# %% [markdown] papermill={"duration": 0.101448, "end_time": "2024-03-14T14:29:12.493137", "exception": false, "start_time": "2024-03-14T14:29:12.391689", "status": "completed"}
...
# %% papermill={"duration": 0.130006, "end_time": "2024-03-14T14:29:12.718722", "exception": false, "start_time": "2024-03-14T14:29:12.588716", "status": "completed"}
...
# %% papermill={"duration": 49.926058, "end_time": "2024-03-14T14:30:02.743348", "exception": false, "start_time": "2024-03-14T14:29:12.817290", "status": "completed"}
...
# %% papermill={"duration": 0.129945, "end_time": "2024-03-14T14:30:03.014163", "exception": false, "start_time": "2024-03-14T14:30:02.884218", "status": "completed"}
